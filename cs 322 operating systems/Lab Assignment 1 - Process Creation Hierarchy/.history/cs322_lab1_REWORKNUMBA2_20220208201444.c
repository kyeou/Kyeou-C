...
void create()
{
    ...
    else
    {
        ...
        //so we have to do an else if, take PCB[newC] (just do it), set the next equal to that
        //then the next else is what handles the next of the already existing child
