...
void prt()
{
    ...
    for_proc
    {
        ...
        printf("p%d  \t%d\t%d\t%d\t\t", p, PV[p].CV[0].max_amt, PV[p].CV[1].max_amt, PV[p].CV[2].max_amt);
        printf("%d\t%d\t%d\t\t", p, PV[p].CV[0].current, PV[p].CV[1].current, PV[p].CV[2].current);
        printf("%d\t%d\t%d\n", p, PV[p].CV[0].potential, PV[p].CV[1].potential, PV[p].CV[2].potential);
...
PV[p].CV[r]->potential = PV[p].CV[r]->max_amt - PV[p].CV->current;
        } // end for res
