...
void entParms()
{
    ...
    int_input3("Enter number of units for resources (r0 to r2):" , RES[0].ramt,  RES[1].ramt, RES[2].ramt);
    int_input3("Enter maximum number of units process p0 will request from each resource (r0 to r2)" , RES[0].ramt,  RES[1].ramt, RES[2].ramt);
    int_input3("Enter maximum number of units process p0 will request from each resource (r0 to r2)" , RES[0].ramt,  RES[1].ramt, RES[2].ramt);int_input3("Enter maximum number of units process p0 will request from each resource (r0 to r2)" , RES[0].ramt,  RES[1].ramt, RES[2].ramt);int_input3("Enter maximum number of units process p0 will request from each resource (r0 to r2)" , RES[0].ramt,  RES[1].ramt, RES[2].ramt);
