...
//PV[0].CV[0].current points to p0's r0 allocat 
...
// if this function returns false -> could not be sequenced
bool compareVEC(cv V1, re V2, int size)
{
...
// bankers algo
// check if potential < available (max_amt - current)
int main()
{
