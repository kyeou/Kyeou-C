...
/*
cd "c:\Users\kyeou\Dropbox\PC (2)\Desktop\csun courses\Spring 2022\cs 322\lab\Lab Assignment 4 - Memory Allocation\" ; if ($?) { gcc jarmon_lab4_memalloc.c -o jarmon_lab4_memalloc } ; if ($?) { .\jarmon_lab4_memalloc }
1
1024
1
2
