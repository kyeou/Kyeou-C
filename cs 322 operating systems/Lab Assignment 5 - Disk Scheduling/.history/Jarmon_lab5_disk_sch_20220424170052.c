...
void fifo() {} //the disk movement is the abs_val(terminal - initial)

void stf() {}

void scan() {} //start a point, go to the 0 direction and if a service is required their service it, then go the other way

void c_scan() {}//start at a point, go towards the end of the disk, when end reached, return to 0 to get cyliders before starting poi
