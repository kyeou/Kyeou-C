...
#define for_proc for (int p = 0; p < proc_amt - 1; p++)
...
void entParms()
{
    ...
    for_proc
    {
        printf("Enter maximum number of units process p%d will request from each resource (r0 to r%d): ", res_amt - 1, p);
