...
//so when we find the smallest possible gap, record the process whos next is gonna be set, call the move function at the next, next should be ready, set that to the add
